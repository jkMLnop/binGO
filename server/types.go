...
type ServerMessage struct {
	...
	BoardReady          bool         `json:"board_ready,omitempty"`          // true when the host already chose a word list (e.g. room board, or a curated profile list), so the host setup lobby can be skipped
}
